<div>
    <div class="flex sm:justify-end justify-center">
        <div class="sm:grid grid-cols-12 sm:pt-10 pt-5">
            <div class="col-span-4"></div>
            <div class="col-span-8">
                <img src="{{asset('img/banner-about.png')}}" class="w-full" />
            </div>
        </div>
    </div>
    <div class="px-8 sm:-mt-4 mt-3">
        <h1 class="text-[#3E3C4F] sm:text-8xl text-4xl leading-none mb-0 uppercase sm:text-left text-center">Sobre<br class="sm:block hidden"> el evento</h1>
    </div>
        ...
        <div class="px-10">
            ...
            <div class="sm:grid grid-cols-12 gap-8 py-10">
                <div class="col-span-5">
                    <img src="{{asset('img/about-photo-1.png')}}" class="w-full mb-6" />
