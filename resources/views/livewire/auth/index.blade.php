<div>
    <div class="sm:grid grid-cols-2">
        <div class="sm:h-screen sm:py-0 py-8 bg-no-repeat bg-cover flex items-center justify-center" style="background-image: url({{asset('img/login-bg.svg')}})">
            <div class="sm:px-15 px-10">
                <a href="{{route('home')}}">
                    <img src="{{asset('img/logo-evento.svg')}}" class="w-full mb-6" alt="{{config('app.name')}}">
                </a>
                ...
                <div class="flex items-center justify-center">
                    <img src="{{asset('img/icono-calendario.svg')}}" class="mr-4">
        ...
        <div class="sm:h-screen sm:py-0 py-8 bg-white flex items-center justify-center">
            <div class="sm:px-15 px-10">
                <img src="{{asset('img/evento-2023.svg')}}" class="mb-4">
